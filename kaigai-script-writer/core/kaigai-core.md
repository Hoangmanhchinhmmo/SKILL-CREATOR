...
| Beat | Cảm xúc | Ví dụ |
|------|---------|-------|
| Beat 1 | Kỳ vọng + căng thẳng | Trận đấu bắt đầu, áp lực lớn dần |
| Beat 2 | Bước ngoặt nhỏ / false peak | Một khoảnh khắc tưởng đã đủ |
| Beat 3 | Twist hoặc setback | Điều bất ngờ xảy ra |
| Beat 4 | True climax — bùng nổ | Khoảnh khắc đỉnh điểm |
| Beat 5 | Aftermath — dư chấn | Phản ứng tức thì sau sự kiện |
